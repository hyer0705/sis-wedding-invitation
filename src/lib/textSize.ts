// 큰 글씨로 보기 — 켜고 끈 상태를 들고, 저장하고, 화면에 반영한다 (2026-09-01 고객 요청).
//
// 배율 값과 크기 계산은 lib/typeScale.ts 에 있다. 크기를 적는 코드가 이 모듈까지
// 끌고 오지 않게 하려는 것이다.
//
...
// 지적을 받아 글로 적힌 바로 바꿨다. 자세한 근거는 components/TextSize.tsx.
